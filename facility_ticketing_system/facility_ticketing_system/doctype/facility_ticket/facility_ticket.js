...
// 				__("Resolution SLA Breached"),
// 				"red"
// 			);
// 		} else if (frm.doc.sla_status === "Follow-up Overdue") {
// 			frm.dashboard.set_headline_alert(
// 				__("Follow-up SLA Overdue"),
// 				"orange"
// 			);
// 		}
...
// 		// Fetch and auto-populate fields from Sub Category
// 		frappe.db.get_doc("Service Sub Category", frm.doc.sub_category).then((sub) => {
// 			if (sub.email_recipient) {
// 				frm.set_value("email_recipient", sub.email_recipient);
// 			}
// 			if (sub.assigned_team) {
// 				frm.set_value("assigned_team", sub.assigned_team);
// 			}
// 			if (sub.default_priority && !frm.doc.request_priority) {
// 				frm.set_value("request_priority", sub.default_priority);
// 			}
// 			if (sub.resolution_sla_minutes) {
// 				frm.set_value("resolution_sla_minutes", sub.resolution_sla_minutes);
// 			}
// 			if (sub.follow_up_sla_minutes) {
// 				frm.set_value("follow_up_sla_minutes", sub.follow_up_sla_minutes);
// 			}

// 			// Set assigned person from Level 1 contact
...
// 	status(frm) {
// 		// Make sure user adds a comment when closing / resolving
...
// // Child table: auto set updated_by
